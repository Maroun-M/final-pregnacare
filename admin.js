  ...
  xhr.onload = function () {
    if (xhr.status === 200) {
      ...
      data.forEach((element) => {
        results += `<div class="item">${element.full_name}</div>
  ...
  xhr.onload = function () {
    if (xhr.status === 200) {
      ...
      let results = `<div class="header">Name</div>
        ...
        <div class="header">Clinic Number</div>
        <div class="header">Delete</div>`;
      data.forEach((element) => {
        results += `<div class="item">${element.full_name}</div>
            <div class="item">${element.age}</div>
            ...
            <div class="item">${element.phone_number}</div>
            <div class="item">${element.clinic_name}</div>
            
            <div class="item ">${element.clinic_number}
            </div>
            <div class="item "><i class="bi bi-trash delete-btn delete-users" style="border:none;" data-id=${element.id}></i>
            </div>`;
      });
