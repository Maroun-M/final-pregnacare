...
<html lang="en">
  ...
  <script src="./doctorMessages.js" defer></script>
</head>
...
<p class="patient-id" hidden></p>
  ...
  <div class="dashboard-wrapper">
    ...
    <div class="content-wrap" style="height:110vh;">
      <div class="hamburger-container">
        <i class="bi bi-list"></i>
      </div>
      <!-- Page content start -->
      <div class="doctor-message-container" style="height:100vh">
