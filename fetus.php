...
<body>
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="sidebar gradient-background">
            ...
            <div class="sidebar-nav-container active" onclick="window.location.href = './fetus.php'">
                <div class="sidebar-nav-logo">
      ...
      <div class="sidebar-nav-container" onclick="window.location.href = './AIChat.php'">
        <div class="sidebar-nav-logo">
      ...
      <hr class="sidebar-divider">
        ...
        <div class="content-wrap ">
            ...
            <form action="./src/patient/patientEntries.php" method="POST" enctype="multipart/form-data" class="inputs-form">
                ...
                <div class="form-inputs-container">
                    ...
                    <div class="rates-input">
                        <input type="text" id="fetal-weight" name="fetal-weight" placeholder="200" >
                    ...
                    <div class="rates-input">
                        <input type="text" id="fetal-heart-rate" name="fetal-heart-rate" placeholder="70" >
                        <span class="measure-units">BPM</span>
                    </div>    
                    <div class="invalid-input-message" id="fetus-error"></div>

                </div>
                <div class="btns-container forms-btns">
                    <button class="tests-btn btns-style" id="add-button" >UPDATE</button>
                </div>
            </form>
            </div>
        </div>
