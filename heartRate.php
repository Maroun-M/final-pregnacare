...
<body>
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="sidebar gradient-background">
            ...
            <div class="sidebar-nav-container active" onclick="window.location.href = './heartRate.php'">
                <div class="sidebar-nav-logo">
            ...
            <div class="user-info-wrap card-display">
                <form action="./src/patient/patientEntries.php" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-inputs-container heart-rate-input">
                        ...
                        <div class="invalid-input-message" id="heart-rate-error"></div>
                        <!-- Element to display error message -->
                        
                    </div>
                    <div class="btns-container forms-btns">
                        <button class="tests-btn btns-style" id="add-button" onclick="validateForm(event)">ADD</button>
