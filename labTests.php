...
<body>
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-nav-container active" onclick="window.location.href = './labTests.php'">
                <div class="sidebar-nav-logo">
        ...
        <div class="content-wrap ">
            ...
            <form action="./src/patient/upload.php" method="POST" enctype="multipart/form-data" class="inputs-form">
