...
?>
    ...
    <div class="content-wrap ">
      ...
      <div class="patients-tables-container card-display ">
        <div class="dr-container tests-container patients-records-table-container-overflow">
        ...
        <div class="btns-container forms-btns">
          <button class="tests-btn btns-style graphs-btn" id="add-button">Graphs</button>
        </div>
