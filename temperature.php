...
<body>
    ...
    <div class="dashboard-wrapper">
        ...
        <div class="sidebar gradient-background">
            ...
            <div class="sidebar-nav-container active" onclick="window.location.href = './temperature.php'">
                <div class="sidebar-nav-logo">
            ...
            <form action="./src/patient/patientEntries.php" method="POST" enctype="multipart/form-data" class="inputs-form">
                ...
                <div class="form-inputs-container">
                    <div class="inputs-header-title">
                        <p>Please insert your temperature:</p>
                        <p class="temperature-detail"></p>

                    </div>
                    <div class="rates-input">
                        <input type="text" id="temperature" name="temperature" placeholder="37" required>
                        <span class="measure-units">°C</span>
                    </div>
                    <div >
                        <p id="temp-error"></p>
                    </div>
